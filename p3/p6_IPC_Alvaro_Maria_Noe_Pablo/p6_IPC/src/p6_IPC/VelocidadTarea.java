...
public class VelocidadTarea extends Medida {
    ...
    public VelocidadTarea (String nombre, Tarea tarea, double optimo, double objetivo, double peorAceptable) {
    ...
    public void calcularMedida (ArrayList<Interaccion> interacciones) {
        ...
        setActual(getTarea().getListaInteraccionesObjetivo().size() / tiempo);
    }
}
